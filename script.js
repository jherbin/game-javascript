  ...
  class Egg {
    ...
    draw(context) {
      ...
      if (this.game.debug) {
        ...
        context.restore();
        context.stroke();
        const displayTimer = (this.hatchTimer * 0.001).toFixed();
        context.fillText(
          displayTimer,
          this.collisionX,
    ...
    render(context, deltaTime) {
      ...
      if (this.score >= this.winningScore) {
        ...
        if (this.lostHatchlings <= 5) {
          message1 = 'You are a great mother!';
          message2 = 'You have won!';
          //win
        } else {
          message1 = 'You are a terrible mother!';
          message2 = 'You lost' + this.lostHatchlings + ' hatchlighs!';
          //lose
        }
